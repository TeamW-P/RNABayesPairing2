...
class BayesianModel(DirectedGraph):
    ...
    **Shortcuts:**
    ...
    def add_cpds(self,node,*cpds ):
        ...
        +------+------+------+---------+------+------+-------+
        """
        #print("INCLUDING CPD INTO BAYESIAN MODEL",cpds,*cpds)
        for cpd in cpds:
            #print("ADDING CPD TO BAYESIAN NETWORK",type(cpd),cpd)
            ...
            for prev_cpd_index in range(len(self.cpds)):
                ...
                self.cpd_order.append(node)
                #print("CPD ADDED",self.cpd_order[-1])
    ...
    def get_cpds(self, node=None):
        ...
        if node:
            ...
            #print("RETURNING SELF.CPDS",flush=True)
            return self.cpds
    ...
    def _get_ancestors_of(self, obs_nodes_list):
        ...
        #I need ancestors to not be a set for now
        #ancestors_list = set()
        ancestors_list = list()
        ...
        #print("ancestors",ancestors_list)
